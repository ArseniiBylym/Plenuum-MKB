    ...
    const Route = {
        ...
        CREATE_NEW_SURVEY_TEMPLATE_BLANK: '/my_surveys/create_new_survey/template/blank',
        MY_TEAM: '/my_team'
    };
    ...
    const ReducersActionType = {
        ...
        PUT_SURVEYS_TO_REDUX: "PUT_SURVEYS_TO_REDUX",
        PUT_TEMPLATES_TO_REDUX: "PUT_TEMPLATES_TO_REDUX"
    };
